...
class LoginScreen: UIView {
    ...
    lazy var signInMetamaskView: UIView = {
        ...
        view.layer.borderColor = UIColor(red: 207 / 255, green: 0 / 255, blue: 192 / 255, alpha: 1.0).cgColor /* #cd00c0 */
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            ...
            self.loginButton.topAnchor.constraint(equalTo: recoverPasswordButton.bottomAnchor, constant: 36),
            ...
            self.lineView.topAnchor.constraint(equalTo: subLoginView.bottomAnchor, constant: 48),
            ...
            self.signInMetamaskView.topAnchor.constraint(equalTo: lineView.bottomAnchor, constant: 48),
